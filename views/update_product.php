...
<link rel="stylesheet" href="../public/css/update.css">
  ...
  <div class="update-tbl">
    <table>
    <from action="../controller/inventory_maintain.php/update_product_details&id=<?php echo $row['p_id']?>">
      <tbody>
       
        <tr>
            <th>Product ID</th>
            <td>   
              <input type='text'class="text"  placeholder="Product Id" name="p_id" value="<?php echo $row['p_id'] ?>" disabled>
            </td>
        </tr>
        <tr>
            <th>Product Name</th>
