       ...
       <table>
            ...
            foreach ($sql as $k => $v)
            {
                ...
                <tr>
                    ...
                    <td><a href="bill_details.php?action=view_bill&id=<?php  echo $values["bill_no"]?>" class="view" title="view"><i class="fa fa-eye" aria-hidden="true" id="tbl-icon">&nbsp&nbsp</i></a></td>
                </tr>
                <?php
            } ?>
            </tbody>
